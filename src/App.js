...
import Fleets from "./pages/cabinet/Fleets";
...
import Reference from "./pages/auth/Reference";
...
import GatewayModal from "./pages/modals/Gateways";
import FleetModal from "./pages/modals/Fleets";
import "./style.css";
import "./admin.css";
