...
export const MainNav = ({language})=>{
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.pageYOffset > 40) {setNavShadow(true);
      ...
      <div className="nav_wrap">
        <div className="nav-left-contents flex_b_c">
          <div className="nav-logo-card">
            <div className="logo"><p> Avi<span>money.</span></p></div>
          </div>
        </div>
      ...
      <div className="footer-middle-contents">
        ...
        <div className="footer-rigth-contents">
          <div className="footer-wrap-last">
            ...
            <div className="footer-links">admin@avimoney.com</div>
            <a className="footer-footer-links" href="mailto:admi@initmarks.com">
              <div className="footer-links">support@avimoney.com</div>
            </a>
