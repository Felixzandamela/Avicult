        ...
        <div className="a_aside_box">
          <div className="a_aside_logo flex_b_c">
            <Link to="/" className="a flex_s_c">
              <div className="flex_c_c a_logo">A</div>
              <div className="a_aside_logo_text">Localhost</div>
            </Link>
          </div>
          <div onClick={()=>handleToggle("openAside")} className="a_aside_scroll">
            <Aside language={props.language} mode={mode} logOut={()=>handleLogOut()}/>
          </div>
          <div className="a_shrunken_box flex_c_c">
            <div className="a_shrunken_box_title">{texts.shrunken[props.language]}</div>
            <input onChange={handleChanges} id="cAudio" checked={props.shrunken === "shrunken"} className="a_inputs"  type="checkbox"/>
          </div>
        </div>
      </aside>
...
const Aside = ({language, mode, logOut})=>{
  return(
    <div className="a_aside_wrap">
     <NavLink className={({isActive})=> isActive ? "a a_active":"a"} to={`/${mode}/dashboard`}>
        <div className="a_aside_items">
          <div className="flex_b_c a_btn">
            <div className="flex_c_c"><i className="bi bi-grid"> </i><p>{texts.dashboard[language]}</p></div>
          </div>
        </div> 
     </NavLink>
     <NavLink className={({isActive})=> isActive ? "a a_active":"a"} to={`/${mode}/support`}>
        <div className="a_aside_items">
          <div className="flex_b_c a_btn">
            <div className="flex_c_c"><i className="bi bi-headset"></i><p>{texts.support[language]}</p></div>
          </div>
        </div>
     </NavLink>
     <NavLink className={({isActive})=> isActive ? "a  a_active":"a"} to={`/${mode}/transactions/deposits`}>
        <div className="a_aside_items">
          <div className="flex_b_c a_btn">
            <div className="flex_c_c"><i className="bi bi-box-arrow-in-up"> </i><p>{texts.deposits[language]}</p></div>
          </div>
        </div> 
     </NavLink>
      <NavLink className={({isActive})=> isActive ? "a  a_active":"a"} to={`/${mode}/transactions/withdrawals`}>
        <div className="a_aside_items">
          <div className="flex_b_c a_btn">
            <div className="flex_c_c"><i className="bi bi-box-arrow-down"> </i><p>{texts.withdrawals[language]}</p></div>
          </div>
        </div>
      </NavLink>
      <NavLink className={({isActive})=> isActive ? "a  a_active":"a"} to={`/${mode}/transactions/commissions`}>
        <div className="a_aside_items">
          <div className="flex_b_c a_btn">
            <div className="flex_c_c"><i className="bi bi-link-45deg"> </i><p>{texts.commissions[language]}</p></div>
          </div> 
        </div>
      </NavLink>
      <NavLink className={({isActive})=> isActive ? "a  a_active":"a"} to={`/${mode}/fleets`}>
        <div className="a_aside_items">
          <div className="flex_b_c a_btn">
            <div className="flex_c_c"><i className="bi bi-box"> </i><p>{texts.fleet[language]}s</p></div>
         </div>
        </div> 
      </NavLink>
      {mode === "admin" && <div>
        <NavLink className={({isActive})=> isActive ? "a  a_active":"a"} to="/admin/payments-gateways">
          <div className="a_aside_items">
            <div className="flex_b_c a_btn">
              <div className="flex_c_c"><i className="bi bi-credit-card"> </i><p>{texts.paymentGateways[language]}</p></div>
            </div>
          </div>
        </NavLink>
        ...
        <NavLink className={({isActive})=> isActive ? "a  a_active":"a"} to="/admin/reviews">
          <div className="a_aside_items">
            <div className="flex_b_c a_btn">
              <div className="flex_c_c"><i className="bi bi-chat-square-quote"></i><p>{texts.reviewsTitle[language]}</p></div>
            </div>
          </div> 
        </NavLink>
      </div>}
